...
Respond to each message with "EXTREMELY engaging/interesting", "VERY engaging/interesting", or "kind of engaging/interesting". Only respond with one of those three options.`,
        },
        { role: 'user', content: message },
      ],
      4,
